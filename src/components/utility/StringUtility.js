const StringUtility = {
    ...
    'SERVICE3_DESCRIPTION': '<p>2 hour minimum $75.00 per hour *Travel costs may apply if outside the Babylon, NY Township area. Virtual party formats can also be arranged. </p> <p>A two hour party can currently accommodate 12 – 16 guest readings with quick  five – ten minute readings. For parties with under (10) guests, longer 10 – 15 minute readings can be provided. </p>.',
